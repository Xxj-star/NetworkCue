...
public class PictureActivity extends BaseActivity {
    ...
    protected void initWidget() {
        ...
        mAdapter.setOnItemClickListener((BaseRecyclerViewAdapter.OnItemClickListener<String>) (view, item, position) -> {
...
//                        .start();
            ...
            PhotoViewer.INSTANCE
                    ...
                    .setShowImageViewInterface((imageView, url) -> Glide.with(PictureActivity.this).load(url).into(imageView))
